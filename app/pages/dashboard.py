...
from app.components.pro_gate import pro_gate
        ...
        rx.el.div(
            ...
            rx.el.button(
                rx.cond(
                    ...
                    rx.el.div(
                        class_name="h-4 w-4 rounded-full border-2 border-blue-300/50 border-t-blue-700 animate-spin"
                    ),
...
def _overview_body() -> rx.Component:
    return rx.el.div(
        ...
        pro_gate(
            insights_section(),
            "Automated insights are a Pro feature",
            "Advanced analytics and AI-powered insights unlock with Pro (₹199/month).",
        ),
        class_name="flex flex-col gap-6 w-full",
    )
...
def _revenue_body() -> rx.Component:
    return rx.el.div(
        ...
        pro_gate(
            profit_section(),
            "Profitability analytics is a Pro feature",
            "Cost, margin and profit analysis unlock with Pro (₹199/month).",
        ),
        class_name="flex flex-col gap-6 w-full",
    )
...
def _customer_body() -> rx.Component:
    return rx.el.div(
        ...
        pro_gate(
            rfm_section(),
            "RFM segmentation is a Pro feature",
            "Recency, frequency and monetary customer segmentation unlocks with Pro (₹199/month).",
        ),
        class_name="flex flex-col gap-6 w-full",
    )
...
def _product_body() -> rx.Component:
    return rx.el.div(
        ...
        pro_gate(
            margin_insights_card(),
            "Margin insights are a Pro feature",
            "Product-level profitability and margin analysis unlock with Pro (₹199/month).",
        ),
        class_name="flex flex-col gap-6 w-full",
    )
...
def _forecast_tab() -> rx.Component:
    return rx.el.div(
        ...
        pro_gate(
            forecast_section(),
            "Sales forecasting is a Pro feature",
            "Revenue forecasting and trend projection unlock with Pro (₹199/month).",
        ),
        class_name="flex flex-col gap-6 w-full",
    )
...
def _report_tab() -> rx.Component:
    return rx.el.div(
        ...
        pro_gate(
            report_section(),
            "Executive reports and exports are a Pro feature",
            "PDF reports, Excel exports and cleaned-data downloads unlock with Pro (₹199/month).",
        ),
        class_name="flex flex-col gap-6 w-full",
    )
...
def _tab_content() -> rx.Component:
    return rx.match(
        ...
        (
            ...
            pro_gate(
                ask_section(),
                "Ask InsightSheet is a Pro feature",
                "Ask questions about your data in plain English with Pro (₹199/month).",
            ),
        ),
        ("report", _report_tab()),
